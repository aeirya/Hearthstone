...
// import com.bubble.hearthstone.net.event.events.LoginRequest;
...
//                         .getGraphics()
//                         .message(
//                             getSave(g).getPrintedVersion()
//                         )
//             );
//         }

//         private UserSave getSave(GameClient client) {
//             return (UserSave)client.sendRequest(Requests.GET_SAVE);
//         }
